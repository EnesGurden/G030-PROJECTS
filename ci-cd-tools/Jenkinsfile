pipeline {
    ...
    stages {
        ...
        stage('Flash-Debug') { 
            steps {
                bat "${TOOL_DIR}\\flash.bat $params.DUT_STLINK_sn ${WORKSPACE}\\Debug\\G030-PROJECTS.bin"
            }
        }
        ...
        stage('Flash-Release') { 
            steps {
                bat "${TOOL_DIR}\\flash.bat $params.DUT_STLINK_sn ${WORKSPACE}\\Release\\G030-PROJECTS.bin"
            }
        }
